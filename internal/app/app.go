...
func New(opts Options) (*Server, func(), error) {
	...
	providers.Register(push.NewDingTalkProvider())
	providers.Register(push.NewWeComProvider())
	providers.Register(push.NewIgotProvider())
	providers.Register(push.NewPushPlusProvider())
	providers.Register(push.NewPushPlusHxtripProvider())
	providers.Register(push.NewFeishuProvider())
	providers.Register(push.NewQmsgProvider())
	providers.Register(push.NewServerChanProvider())
	providers.Register(push.NewServerChainProvider())
	providers.Register(push.NewGoCqhttpProvider())
	providers.Register(push.NewAtriProvider())
	providers.Register(push.NewPushDeerProvider())
	providers.Register(push.NewIftttProvider())
	providers.Register(push.NewWecombotProvider())
	providers.Register(push.NewDiscordProvider())
	providers.Register(push.NewWxPusherProvider())
